...
function PluginComponent() {
    ...
    const items = [
        {
            id: 1, label: 'Speech to text', function: () => {
                core.system.speechToText({
                    lanugage: 'en-US',
                    description: 'Please speak here...',
                    callback: (res) => {
        ...
        {
            id: 1, label: 'Text to speech', function: () => {
                core.system.textToSpeech({
                    language: 'en-US',
                    text: 'Hello React Vite',
                    callback: (res) => {
                        core.alertDialog("Result: " + res);
                    },
                });
